...
<title>登录－光伏一体机管理系统</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<link rel="stylesheet"
	href="${pageContext.servletContext.contextPath }/login_files/min.css">
<link rel="stylesheet"
	href="${pageContext.servletContext.contextPath }/login_files/login.css">
<link
	href="${pageContext.servletContext.contextPath }/login_files/css.css"
...
<body onload="javascript:to_top()"
	style="background-image: url('${pageContext.servletContext.contextPath }/login_files/sky2.jpg');margin-top:0px;background-repeat:no-repeat;background-size: 100% auto;">
		...
		<form id="loginform" name="loginform" class="form-vertical"
			...
			<div class="control-group normal_text">
				<table style="width: 100%">
					<tr>
						<td align="left"><img
							src="${pageContext.servletContext.contextPath }/login_files/logo_left.png"
							alt="Logo"></td>
						<td align="center" style="font-weight: bold;color: gray;">登录－光伏一体机管理系统</td>
						<td align="right"><img
							src="${pageContext.servletContext.contextPath }/login_files/logo_left.png"
							alt="Logo"></td>
					</tr>
				...
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_ly" style="background: #28b779"><img
							src="${pageContext.servletContext.contextPath }/login_files/account_1.png"
				...
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_ly"><img
							src="${pageContext.servletContext.contextPath }/login_files/lock_1.png"
			...
			<div class="form-actions">
				<span class="pull-left" style="width: 33%"><a href="#"
					...
					class="pull-left" style="width: 35%"><a href="install.shtml"
