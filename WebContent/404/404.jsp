                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width=534 border=0>
                    ...
                    <TR>
                      ...
                      <span style="color: red;font-weight: 900;font-size: 40px;">404</span><br><br>
                        <P><FONT 
                        class=red size="5"><b>您的访问的页面可能被删除或不存在。</b></FONT><BR><BR><font color="blue" size="3">你的IP已经记录，请勿进行非法操作！！</font><BR><BR>
                        <P style="font-size: 14px">请尽快联系管理员.........</P>
                        <p>
                        <a href="javascript:void(0)" onclick="history.go(-1)" style="font-weight: 400;color:seagreen;font-size: 16px;float: right;">--->> 静悄悄的返回</a>
                        </p>
                        </TD>
                      <TD rowSpan=2><IMG height=239 
