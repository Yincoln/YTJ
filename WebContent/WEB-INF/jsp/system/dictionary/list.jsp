...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/system/dictionary/list.js"></script>
</head>
<body>
			...
			<form class="form-inline" name="form" id="searchForm"
				...
				<div class="form-group">
					<label class="control-label"> <span
						class="h4 font-thin v-middle">code:</span>
					</label> <input class="input-medium ui-autocomplete-input" id="code"
						name="code">
				</div>
