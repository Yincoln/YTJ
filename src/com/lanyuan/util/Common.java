...
public class Common {
	 ...
	 * @return
	 */
	public static String findUserSessionAccountName(){
		Object obj = SecurityUtils.getSubject().getSession().getAttribute("userSessionAccountName");
		if (obj != null) {
			return obj.toString();
		}
		return null;
	 ...
	 * @return
	 */
	public static String findPlayerSessionId(){
		Object obj = SecurityUtils.getSubject().getSession().getAttribute("playerSessionId");
		if (obj != null) {
			return obj.toString();
		}
		return null;
